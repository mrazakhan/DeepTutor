...
AP_COURSES = [
    # ── Computer Science ──────────────────────────
    {
        ...
        "description": "Introductory college-level course in computer science using Java. Emphasizes object-oriented programming, data structures, and algorithm design.",
        "exam_format": json.dumps({
            "sections": [
                {"name": "Multiple Choice", "count": 40, "minutes": 90, "calculator": False},
                {"name": "Free Response", "count": 4, "minutes": 90, "calculator": False}
            ],
            "reference": "Java Quick Reference"
        }),
        "units": [
            {"number": 1, "title": "Primitive Types", "topics": [
                {"num": "1.1", "title": "Why Programming? Why Java?"},
                {"num": "1.2", "title": "Variables and Data Types"},
                {"num": "1.3", "title": "Expressions and Assignment Statements"},
                {"num": "1.4", "title": "Compound Assignment Operators"},
                {"num": "1.5", "title": "Casting and Ranges of Variables"},
            ]},
            {"number": 2, "title": "Using Objects", "topics": [
                {"num": "2.1", "title": "Objects: Instances of Classes"},
                {"num": "2.2", "title": "Creating and Storing Objects"},
                {"num": "2.3", "title": "Calling a Void Method"},
                {"num": "2.4", "title": "Calling a Void Method with Parameters"},
                {"num": "2.5", "title": "Calling a Non-void Method"},
                {"num": "2.6", "title": "String Objects: Concatenation, Literals, and More"},
                {"num": "2.7", "title": "String Methods"},
                {"num": "2.8", "title": "Wrapper Classes: Integer and Double"},
                {"num": "2.9", "title": "Using the Math Class"},
            ]},
            {"number": 3, "title": "Boolean Expressions and if Statements", "topics": [
                {"num": "3.1", "title": "Boolean Expressions"},
                {"num": "3.2", "title": "if Statements and Control Flow"},
                {"num": "3.3", "title": "if-else Statements"},
                {"num": "3.4", "title": "else if Statements"},
                {"num": "3.5", "title": "Compound Boolean Expressions"},
                {"num": "3.6", "title": "Equivalent Boolean Expressions"},
                {"num": "3.7", "title": "Comparing Objects"},
            ]},
            {"number": 4, "title": "Iteration", "topics": [
                {"num": "4.1", "title": "while Loops"},
                {"num": "4.2", "title": "for Loops"},
                {"num": "4.3", "title": "Developing Algorithms Using Strings"},
                {"num": "4.4", "title": "Nested Iteration"},
                {"num": "4.5", "title": "Informal Code Analysis"},
            ]},
            {"number": 5, "title": "Writing Classes", "topics": [
                {"num": "5.1", "title": "Anatomy of a Class"},
                {"num": "5.2", "title": "Constructors"},
                {"num": "5.3", "title": "Documentation with Comments"},
                {"num": "5.4", "title": "Accessor Methods"},
                {"num": "5.5", "title": "Mutator Methods"},
                {"num": "5.6", "title": "Writing Methods"},
                {"num": "5.7", "title": "Static Variables and Methods"},
                {"num": "5.8", "title": "Scope and Access"},
                {"num": "5.9", "title": "this Keyword"},
                {"num": "5.10", "title": "Ethical and Social Implications of Computing"},
            ]},
            {"number": 6, "title": "Array", "topics": [
                {"num": "6.1", "title": "Array Creation and Access"},
                {"num": "6.2", "title": "Traversing Arrays"},
                {"num": "6.3", "title": "Enhanced for Loop for Arrays"},
                {"num": "6.4", "title": "Developing Algorithms Using Arrays"},
            ]},
            {"number": 7, "title": "ArrayList", "topics": [
                {"num": "7.1", "title": "Introduction to ArrayList"},
                {"num": "7.2", "title": "ArrayList Methods"},
                {"num": "7.3", "title": "Traversing ArrayLists"},
                {"num": "7.4", "title": "Developing Algorithms Using ArrayLists"},
                {"num": "7.5", "title": "Searching"},
                {"num": "7.6", "title": "Sorting"},
                {"num": "7.7", "title": "Ethical Issues Around Data Collection"},
            ]},
            {"number": 8, "title": "2D Array", "topics": [
                {"num": "8.1", "title": "2D Arrays"},
                {"num": "8.2", "title": "Traversing 2D Arrays"},
            ]},
            {"number": 9, "title": "Inheritance", "topics": [
                {"num": "9.1", "title": "Creating Superclasses and Subclasses"},
                {"num": "9.2", "title": "Writing Constructors for Subclasses"},
                {"num": "9.3", "title": "Overriding Methods"},
                {"num": "9.4", "title": "super Keyword"},
                {"num": "9.5", "title": "Creating References Using Inheritance Hierarchies"},
                {"num": "9.6", "title": "Polymorphism"},
                {"num": "9.7", "title": "Object Superclass"},
            ]},
            {"number": 10, "title": "Recursion", "topics": [
                {"num": "10.1", "title": "Recursion"},
                {"num": "10.2", "title": "Recursive Searching and Sorting"},
            ]},
        ]
    },
    {
